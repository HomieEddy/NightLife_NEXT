...
const SEGMENTS: DemoSegment[] = [
  {
    ...
    features: [
      ...
      },
      {
        ...
        guide: "Every order, filterable by zone, staff and table tab.",
        href: "/manager/orders",
      },
      {
        icon: BarChart3,
        title: "Historical analytics",
        guide: "Sales, staff and inventory over any date range.",
      ...
      },
      {
        ...
        guide: "Bottles, curated packages, time-boxed discount rules.",
        href: "/manager/menu",
      },
      {
        icon: ClipboardList,
      ...
      },
      {
        ...
        guide: "Roster, zone assignments, a night-first weekly schedule.",
        href: "/manager/staff",
      },
      {
        icon: CalendarDays,
        title: "Reservations, events & promos",
        guide: "Booking board, event guestlists, promo-code validator.",
        href: "/manager/reservations",
      },
      {
        icon: CreditCard,
        title: "Settings & subscription",
        guide: "Stacked fees and taxes, SLA tuning, the venue's plan.",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        guide: "Live queue counts plus tonight's sold-out board.",
        href: "/staff",
      },
      {
        icon: UserCheck,
        title: "Guest approvals & tab closures",
        guide: "Wave in QR joins, settle cash-out requests.",
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        guide: "Close out, full-night receipt, split it any way.",
        href: "/g/demo-table",
      },
    ],
  },
...
const HOUSE_RULES: {
...
}[] = [
  {
    ...
    line: "One-tap personas. Any PIN works.",
    href: "/login",
  ...
  },
  {
    ...
    line: "Reload resets the night — use in-app links.",
  },
  {
    icon: Sparkles,
    title: "Play the other side",
    line: "“Simulate” buttons stand in for host and kitchen.",
  },
  {
    icon: Clock,
    title: "Guided onboarding",
    line: "Your first manager visit opens the setup wizard.",
    href: "/manager",
