...
import { DEMO_GROUPS, WALKTHROUGH } from "./demo-guide-content";
      ...
      <TabsContent value="walkthrough" id="walkthrough" className="scroll-mt-24 pt-8">
        <Reveal>
          <p className="text-voice text-sm text-muted-foreground">
            The fastest way to feel the whole loop — one order travelling guest to staff to
            manager, in five minutes. Use in-app links between steps so the night doesn&apos;t
            reset.
          </p>
        </Reveal>
