...
import { mockBlackoutDates } from "@/lib/mock-data/blackout-dates";
...
export const mockReservationService = {
  ...
  async createReservation(input: {
    ...
    if (zoneBlocked) throw new Error("This date is unavailable — no reservations accepted.");
