...
export const mockChatMessages: ChatMessage[] = [
  ...
  { id: "cm-5", channel: "security", authorId: "st-viktor", authorName: "Viktor Michaud", authorRole: "security", body: "All clear on mezzanine. Rotating to main floor", sentAt: minsAgo(20) },
  { id: "cm-6", channel: "bar", authorId: "st-theo", authorName: "Théo Tremblay", authorRole: "bartender", body: "Running low on limes, sending someone to storage", sentAt: minsAgo(12) },
  { id: "cm-7", channel: "floor", authorId: "st-lucas", authorName: "Lucas Gagné", authorRole: "host", body: "MF-05 asking about happy hour — ends 23:30, remind guests", sentAt: minsAgo(6) },
];
