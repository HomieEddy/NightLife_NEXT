...
export const mockStaff: StaffMember[] = [
  ...
  // Nina's zones: VIP + Terrace — she'll see help from those zones only (not zone-dance / zone-bar).
  ...
  { id: "st-viktor", venueId: "venue-1", name: "Viktor Michaud",  role: "security",   phone: "+1 514 555 0107", email: "viktor@velvetmtl.club", accountStatus: "active",    assignedZoneIds: ["zone-vip", "zone-dance"],     isOnShift: true,  avatarInitials: "VM" },
  { id: "st-marcus", venueId: "venue-1", name: "Marcus Fontaine", role: "security",   phone: "+1 514 555 0111", email: "marcus@velvetmtl.club", accountStatus: "active",    assignedZoneIds: ["zone-terrace", "zone-bar"],   isOnShift: true,  avatarInitials: "MF" },
