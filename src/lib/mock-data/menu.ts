...
const washersGroup: ModifierGroup = {
  ...
  isActive: true,
  options: [
    { id: "wa-1", name: "Carafe de jus de canneberge", priceDelta: 0, maxQuantity: 4, inventoryItemId: "mi-juice-carafe", isActive: true },
    { id: "wa-2", name: "Carafe de jus d'orange", priceDelta: 0, maxQuantity: 4, inventoryItemId: "mi-juice-carafe", isActive: true },
    { id: "wa-3", name: "Set soda & tonic", priceDelta: 0, maxQuantity: 4, inventoryItemId: "mi-soda-set", isActive: true },
    { id: "wa-4", name: "Red Bull 4-pack", priceDelta: 24, maxQuantity: 6, inventoryItemId: "mi-redbull", isActive: true },
    { id: "wa-5", name: "Fever-Tree ginger beer set", priceDelta: 14, maxQuantity: 4, inventoryItemId: "mi-soda-set", isActive: true },
  ],
};
...
const presentationGroup: ModifierGroup = {
  ...
  isActive: true,
  options: [
    { id: "pr-1", name: "Service standard", priceDelta: 0, maxQuantity: 1, isActive: true },
    { id: "pr-2", name: "Défilé de sparklers", priceDelta: 25, maxQuantity: 1, isActive: true },
    { id: "pr-3", name: "Enseigne LED + défilé", priceDelta: 60, maxQuantity: 1, isActive: true },
  ],
};
...
export const mockCategories: MenuCategory[] = [
  ...
  { id: "cat-tequila", venueId: "venue-1", name: "Tequila", description: "Blanco, reposado et añejo — citrons et sel inclus", sortOrder: 2, isActive: true, modifierGroups: spirits },
  { id: "cat-vodka", venueId: "venue-1", name: "Vodka", description: "Servie glacée à votre table avec vos washers préférés", sortOrder: 3, isActive: true, modifierGroups: spirits },
  { id: "cat-cognac", venueId: "venue-1", name: "Cognac", description: "V.S.O.P et X.O pour la banquette du fond", sortOrder: 4, isActive: true, modifierGroups: spirits },
  { id: "cat-rhum", venueId: "venue-1", name: "Rhum", description: "Rhums caribéens vieillis, sec ou long drink", sortOrder: 5, isActive: true, modifierGroups: spirits },
  { id: "cat-whisky", venueId: "venue-1", name: "Whisky", description: "Single malts et assemblages rares", sortOrder: 6, isActive: true, modifierGroups: spirits },
  { id: "cat-gin", venueId: "venue-1", name: "Gin", description: "Bouteilles botaniques avec toniques premium", sortOrder: 7, isActive: true, modifierGroups: spirits },
  { id: "cat-washers", venueId: "venue-1", name: "Washers", description: "Jus, sodas, boissons énergisantes et eau pour votre set-up", sortOrder: 8, isActive: true, modifierGroups: [] },
];
...
export const mockMenuItems: MenuItem[] = [
  ...
  // Washers
  { id: "mi-redbull", categoryId: "cat-washers", name: "Red Bull 4-pack", description: "Original, sans sucre ou tropical.", price: 24, icon: "washer", tags: [], isAvailable: true, inventory: 60 },
  { id: "mi-juice-carafe", categoryId: "cat-washers", name: "Carafe de jus frais", description: "Canneberge, orange ou ananas.", price: 14, icon: "washer", tags: [], isAvailable: true, inventory: 40 },
  { id: "mi-soda-set", categoryId: "cat-washers", name: "Set de sodas premium", description: "Tonic, ginger beer et club soda.", price: 12, icon: "washer", tags: [], isAvailable: true, inventory: 50 },
  { id: "mi-evian", categoryId: "cat-washers", name: "Evian 75cl", description: "Eau minérale plate.", price: 8, icon: "washer", tags: [], isAvailable: true, inventory: 80 },
];
