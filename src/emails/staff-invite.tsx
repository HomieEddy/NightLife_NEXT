import { Html, Head, Preview, Body, Container, Section, Text, Link, Heading } from "@react-email/components";
...
export function StaffInviteEmail({ venueName, inviteUrl, roleLabel }: StaffInviteProps) {
  return (
    <Html>
      <Head />
      <Preview>You've been invited to join {venueName} on NightLife</Preview>
      <Body style={{ backgroundColor: "#0a0a0a", fontFamily: "system-ui, sans-serif", padding: "40px 0" }}>
        <Container style={{ maxWidth: 480, margin: "0 auto", padding: "32px", backgroundColor: "#141414", borderRadius: 12, border: "1px solid #272726" }}>
          ...
          <Text style={{ color: "#e4e4e4", fontSize: 16, lineHeight: 1.6 }}>
            You&apos;ve been invited to join <strong>{venueName}</strong> as a <strong>{roleLabel}</strong>.
          </Text>
