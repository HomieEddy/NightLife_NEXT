    ...
    promoters: [
      {
        ...
        promoterName: "Julien Dubois",
        reservationsCreated: 8,
        reservationsConfirmed: 6,
        reservationsSeated: 5,
        showUpRate: 0.83,
        guestsFunneled: 18,
        attributedRevenue: 2400,
        avgSpendPerGuest: 133.33,
        avgSpendPerParty: 480,
        topTable: { tableCode: "TER-01", revenue: 840 },
      },
      {
        promoterId: "st-chloe",
        promoterName: "Chloé Mercier",
        reservationsCreated: 4,
        reservationsConfirmed: 3,
        reservationsSeated: 3,
        showUpRate: 1.0,
        guestsFunneled: 26,
        attributedRevenue: 5800,
        avgSpendPerGuest: 223.08,
        avgSpendPerParty: 1933.33,
        topTable: { tableCode: "VIP-02", revenue: 3200 },
      },
    ],
    totalGuestsFunneled: 44,
    totalAttributedRevenue: 8200,
  },
};
